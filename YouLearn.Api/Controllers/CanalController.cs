...
namespace YouLearn.Api.Controllers
{
    public class CanalController : Base.ControllerBase
    {
        ...
        public CanalController(IUnitOfWork unityOfWork, IServiceCanal serviceCanal, IHttpContextAccessor httpContextAccessor) :base(unityOfWork)
        {
        ...
        public async Task<IActionResult> Excluir(Guid id)
        {
            try
            {
                Guid idUsuario = Guid.Parse("35129E18-0DAA-4994-B5A6-CBC3E7886029");
